...
class Controller_Borrow extends \Controller_Common {
    ...
    public function action_index() {
        ...
        $this->viewContent('borrow/borrow_top_view', '借りている一覧表');
        
    }
    
    public function action_edit_data($lend_and_borrow_mst_id = null) {       
        //TO DO:facebookからユーザ情報の取得したい
        ...
        $this->view_data['type'] = \Config::get('type_borrow');
        
        $this->viewContent('borrow/borrow_edit_data_view', '借りているリスト登録');
    }
